...
function DrawerHeader({ token }) {
  ...
  return (
    <>
      ...
      <Drawer
        title={
          <span className="font-bold text-3xl dark:text-or">shover👣</span>
        }
        placement="right"
        onClose={onClose}
        open={open}
      ...
      >
        <div className="flex flex-col gap-4">
          <Link
            href="/"
            className="text-blue-700  neumorphic  p-2 rounded-md dark:text-white hover:text-blue-500 transition-colors cursor-pointer"
          >
            صفحه اصلی
          </Link>
          ...
          {user?.role === "admin" && (
            <Link
              href="/panelAdmin"
              className="text-black  neumorphic  p-2 rounded-md dark:text-white hover:text-blue-500 transition-colors cursor-pointer"
            >
              پنل ادمین
            </Link>
          )}
          ...
          <div className="flex flex-col mt-[5px] ">
            <Link
              href="/products"
              className="neumorphic p-2 mt-[3px]  rounded-md  pr-1 text-xm dark:text-white hover:text-blue-500 transition-colors cursor-pointer"
            >
              محصولات
            </Link>
          </div>

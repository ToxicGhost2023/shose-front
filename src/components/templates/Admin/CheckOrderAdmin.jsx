...
import { getOrdersAsync, deleteOrderAsync, updateOrderStatusAsync } from "@/store/slice/orderSlice";
                ...
                {orders.map((order) => (
                    ...
                    >
                        ...
                        <div className="text-gray-600 text-sm space-y-2 mb-4 dark:text-or">
                            <p>مبلغ کل: <span className="font-medium ">{order.totalAmount.toLocaleString()} تومان</span></p>
